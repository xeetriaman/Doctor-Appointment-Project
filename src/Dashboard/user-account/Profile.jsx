...
const Profile = ({user}) => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    photo: null, // Initialize with empty string
    gender: "",
    bloodType: "",
  });
    ...
    <div className='mt-10'>
      <form onSubmit={submitHandler}>
        ...
        <div className="mb-5">
          ...
          className='w-full pr-4 py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor
          placeholder:text-textColor cursor-pointer' readOnly/>
  ...
  {formData.photo && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center relative z-10">
