      ...
      <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
        ...
        <div>
          <div className='lg:w-[570px]'>
            ...
            <p className='text__para'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quis numquam voluptatem ratione ea esse illum ex facere. Rerum, saepe eum.</p>
          ...
          <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
            ...
            <div>
              ...
              <p className='text__para'>Overall Hospitals in Nepal</p>
            </div>
            <div>
    ...
    <div className='container'> 
      ...
      <div className='py-[30px] px-5'>
        ...
        <div className='mt-[30px]'>
          ...
          <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group 
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
         ...
         <div className="xl:w-[670px]">
          <h2 className="heading">
            Get virtual treatment<br/>anytime.</h2>
          <ul className="pl-4">
